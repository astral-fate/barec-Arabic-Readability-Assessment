...
# --- File Paths ---
# Ensure these files are uploaded to your Colab environment or adjust path as needed
...
def load_data_for_training():
    ...
    try:
        ...
        # ***** FIX 1: Correctly process test.csv for the sentence-level task *****
        # Keep the original 'ID' column and rename it to 'Sentence ID'
        test_df = test_df[['ID', 'Sentence']].rename(columns={'ID': 'Sentence ID', 'Sentence': 'text'})
...
# =====================================================================================
# 5. MODEL AND DATASET DEFINITION (No Changes Needed)
# =====================================================================================
...
# =====================================================================================
# 6. TRAINING (Using Optimized Settings)
# =====================================================================================
...
# =====================================================================================
# 7. CORRECTED PREDICTION AND SUBMISSION FILE GENERATION
# =====================================================================================
print("\n===== GENERATING SENTENCE-LEVEL PREDICTIONS ON THE TEST SET =====\n")
predictions = trainer.predict(test_dataset)
test_logits = predictions.predictions

# Get predicted class (1-19) for each sentence
sentence_level_preds = np.argmax(test_logits, axis=1) + 1

# ***** FIX 2: Create the submission DataFrame in the correct format *****
# REMOVED the incorrect document-level aggregation.
# The DataFrame is now created with 'Sentence ID' and the direct sentence predictions.
submission_df = pd.DataFrame({
    'Sentence ID': test_df['Sentence ID'],
    'Prediction': sentence_level_preds
})
