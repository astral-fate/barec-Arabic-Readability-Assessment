...
| Exp id | Training parameters | Data distribution | Results on the blind test set senses (top 83.9) | Results on test set document (top 79.20) | Checkpoint/GitHub repo |
| :--- | :--- | :--- | :--- | :--- | :--- |
| **Experiment 1** |\<pre\>\<code\>training\_args = TrainingArguments(\   output\_dir=CHECKPOINT\_DIR,\   num\_train\_epochs=6,\   per\_device\_train\_batch\_size=16,\   per\_device\_eval\_batch\_size=32,\   learning\_rate=5e-5,\   warmup\_ratio=0.1,\   weight\_decay=0.01,\   logging\_steps=100,\   evaluation\_strategy="epoch",\   save\_strategy="epoch",\   load\_best\_model\_at\_end=True,\   metric\_for\_best\_model="qwk",\   greater\_is\_better=True,\   save\_total\_limit=2,\   fp16=torch.cuda.is\_available(),\   report\_to="none"\<br\>)\</code\>\</pre\> | 1. **Loading BAREC data...** \ - Loaded 54845 BAREC training records. \ - Loaded 7310 BAREC validation records. \2. **Loading and mapping Osman data...** \ - Loaded and mapped 9703 Osman training records. \ - Loaded and mapped 1380 Osman validation records. \3. **Combining BAREC and Osman datasets...** \ - Combined training data size: 64548 records. \ - Combined validation data size: 8690 records. | **Scores:**\`{'accuracy': 48.0, 'accuracy+-1': 73.3, 'avg_abs_dist': 1.1, 'qwk': 83.5, 'accuracy_7': 62.9, 'accuracy_5': 67.5, 'accuracy_3': 74.1}` | **Scores:** \`{'accuracy': 40.0, 'accuracy+-1': 79.0, 'avg_abs_dist': 0.8, 'qwk': 73.8, 'accuracy_7': 66.0, 'accuracy_5': 66.0, 'accuracy_3': 91.0}` | `D:\arabic_readability_project\results_open\regression_combined_readability-arabertv2-d3tok-reg\checkpoint-32280` \osman n barec \submission\_combined\_model\_on\_docs |
| **Experiment 2** |\<pre\>\<code\>training\_args = TrainingArguments(\   output\_dir=CHECKPOINT\_DIR,\   num\_train\_epochs=18,\   per\_device\_train\_batch\_size=16,\   per\_device\_eval\_batch\_size=32,\   learning\_rate=2e-5,\   warmup\_ratio=0.1,\   weight\_decay=0.01,\   logging\_steps=100,\   evaluation\_strategy="epoch",\   save\_strategy="epoch",\   load\_best\_model\_at\_end=True,\   metric\_for\_best\_model="qwk",\   greater\_is\_better=True,\   save\_total\_limit=2,\   fp16=torch.cuda.is\_available(),\   report\_to="none"\<br\>)\</code\>\</pre\> | Loaded 64548 training and 8690 validation records. | **Scores:** \`{'accuracy': 48.8, 'accuracy+-1': 71.3, 'avg_abs_dist': 1.1, 'qwk': 83.9, 'accuracy_7': 62.5, 'accuracy_5': 67.6, 'accuracy_3': 74.3}`| **Scores:** \`{'accuracy': 39.0, 'accuracy+-1': 87.0, 'avg_abs_dist': 0.8, 'qwk': 76.1, 'accuracy_7': 68.0, 'accuracy_5': 68.0, 'accuracy_3': 91.0}` | `D:\arabic_readability_project\results_dares_v3\regression_combined_readability-arabertv2-d3tok-reg\checkpoint-68595` \re-train osman\_v3.ipynb |
| **Experiment 3** |\<pre\>\<code\>training\_args = TrainingArguments(\   output\_dir=CHECKPOINT\_DIR,\   num\_train\_epochs=18,\   per\_device\_train\_batch\_size=16,\   per\_device\_eval\_batch\_size=32,\   learning\_rate=3e-5,\   warmup\_ratio=0.1,\   weight\_decay=0.01,\   logging\_steps=100,\   evaluation\_strategy="epoch",\   save\_strategy="epoch",\   load\_best\_model\_at\_end=True,\   metric\_for\_best\_model="qwk",\   greater\_is\_better=True,\   save\_total\_limit=2,\   fp16=torch.cuda.is\_available(),\   report\_to="none"\<br\>)\</code\>\</pre\> | Successfully loaded 107,577 training and 8,690 validation records. \(all combined data barec + samer + dares) | **Scores:** \`{'accuracy': 41.1, 'accuracy+-1': 73.5, 'avg_abs_dist': 1.1, 'qwk': 83.6, 'accuracy_7': 60.4, 'accuracy_5': 66.4, 'accuracy_3': 74.3}` | **Scores:** \`{'accuracy': 38.0, 'accuracy+-1': 82.0, 'avg_abs_dist': 0.8, 'qwk': 74.6, 'accuracy_7': 66.0, 'accuracy_5': 67.0, 'accuracy_3': 92.0}` | `D:\arabic_readability_project\results_3_data_v2\regression_combined_readability-arabertv2-d3tok-reg\checkpoint-60516` \re-train osman\_v4.ipynb |
| **Experiment 4** |\<pre\>\<code\>training\_args = TrainingArguments(\   output\_dir=CHECKPOINT\_DIR,\   num\_train\_epochs=10,\   per\_device\_train\_batch\_size=16,\   per\_device\_eval\_batch\_size=32,\   learning\_rate=3e-5, \   warmup\_ratio=0.1,\   weight\_decay=0.01,\   logging\_steps=100,\   evaluation\_strategy="epoch",\   save\_strategy="epoch",\   load\_best\_model\_at\_end=True,\   metric\_for\_best\_model="qwk",\   greater\_is\_better=True,\   save\_total\_limit=2,\   fp16=torch.cuda.is\_available(),\   report\_to="none"\<br\>)\</code\>\</pre\> | 64548 training and 8690 validation records. | 'qwk': 83.6 | 78.60 (27/7, 3:01 am) \77.90 (26/7, 22:09) | re-train osman \`D:\arabic_readability_project\results_dares_v2\regression_combined_readability-arabertv2-d3tok-reg\checkpoint-72630` \`D:\arabic_readability_project\results_dares_v2\regression_combined_readability-arabertv2-d3tok-reg\checkpoint-40350` \evaluate docuemnt on dares.ipynb |
| **Experiment 5** |\<pre\>\<code\>training\_args = TrainingArguments(\   output\_dir=CHECKPOINT\_DIR,\   num\_train\_epochs=20,\   per\_device\_train\_batch\_size=16,\   per\_device\_eval\_batch\_size=32,\   learning\_rate=5e-5,\   warmup\_ratio=0.1,\   weight\_decay=0.01,\   logging\_steps=100,\   evaluation\_strategy="epoch",\   save\_strategy="epoch",\   load\_best\_model\_at\_end=True,\   metric\_for\_best\_model="qwk",\   greater\_is\_better=True,\   save\_total\_limit=2,\   fp16=torch.cuda.is\_available(),\   report\_to="none"\<br\>)\</code\>\</pre\> | - Successfully loaded 68715 total records. \- Identified 54847 BAREC records and 13868 DARES records. \- Performed stratified split on DARES data (15.0% for dev set). \- New training set: 66634 records. \- New development set: 9391 records. | **Most likely (Scores):** \`{'accuracy': 50.2, 'accuracy+-1': 72.4, 'avg_abs_dist': 1.1, 'qwk': 83.0, 'accuracy_7': 63.8, 'accuracy_5': 68.3, 'accuracy_3': 74.7}` | **Scores:** \`{'accuracy': 37.0, 'accuracy+-1': 86.0, 'avg_abs_dist': 0.8, 'qwk': 79.2, 'accuracy_7': 65.0, 'accuracy_5': 65.0, 'accuracy_3': 92.0}` | `D:\anabic readability project results dares v2\regression combined readability-arabertv2-d3tok-reg checkpoint-72630` \`barec in dares v2.ipynb` \File: `evalaute doc_on dares v3` |
